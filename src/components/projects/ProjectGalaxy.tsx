            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-8 h-full overflow-y-auto">
              {projects.map((p) => (
                <button
                  ...
                  className="p-6 rounded border border-blue-500/10 bg-black/30 hover:bg-[#0d0d12]/50 hover:border-blue-500/30 text-left transition-all duration-300 relative group focus-visible:ring-2 focus-visible:ring-blue-500"
                  data-cursor-magnetic
                >

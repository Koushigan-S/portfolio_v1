    ...
    <section id="resume" className="relative py-24 bg-transparent border-b border-blue-500/10" aria-label="Resume Section">
      <div className="container text-center relative z-10">
        ...
        >
          {/* Card body */}
          <div
            className="p-8 rounded border bg-black/60 border-blue-500/15 group-hover:border-blue-500/35 transition-all duration-300 relative cursor-pointer shadow-[0_0_25px_rgba(59,130,246,0.1)]"

    ...
    <section id="resume" className="relative py-24 bg-transparent border-b border-blue-500/10" aria-label="Resume Section">
      <div className="container text-center relative z-10">
        ...
        >
          {/* Card body */}
          <div
            className="p-10 rounded border bg-black/60 border-blue-500/15 group-hover:border-blue-500/35 transition-all duration-300 relative cursor-pointer shadow-[0_0_25px_rgba(59,130,246,0.1)]"
      ...
      <AnimatePresence>
        {isOpen && (
          <div className="fixed inset-0 z-[8000] flex items-center justify-center p-4">
            ...
            <motion.div
              className="relative z-10 w-full max-w-3xl bg-[#0d0d12]/95 border border-blue-500/20 rounded-xl p-10 md:p-14 overflow-y-auto max-h-[90vh] shadow-[0_0_50px_rgba(59,130,246,0.15)] font-mono text-xs text-[#a0a0b0]"
